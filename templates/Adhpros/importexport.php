<h4>Import<h4>
<div class="row">
    <form id="importadhpro" class="col s12" action="/adhpros/import" method="post" enctype="multipart/form-data">
    <div class="row">
...
<div class="row">
    <div class="col offset-s1">
        <a class="btn waves-effect waves-light" href="/adhpros/export"><i class="material-icons right">send</i>Exporter</a>
    </div>
</div>